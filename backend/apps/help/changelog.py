...
P_RELEASES: List[ReleaseNote] = [
    ...
    ReleaseNote(
        ...
        fixes=[
            ...
            "App icons: an app's icon is one emoji, shown on its tile and in the dock; the old icon names were never drawn, which is why every app wore the same generic mark.",
