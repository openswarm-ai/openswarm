...
from backend.apps.agents.HaikFix.tools.make_builtin_toolkit.open_swarm_toolkits.browser_toolkit.handlers.make_create_browser_agent_handler import (
    make_create_browser_agent_handler, CreateBrowserAgentInput,
)
from backend.apps.agents.HaikFix.tools.make_builtin_toolkit.open_swarm_toolkits.browser_toolkit.handlers.make_invoke_browser_agent_handler import (
    make_invoke_browser_agent_handler, InvokeBrowserAgentInput,
)
from backend.apps.agents.HaikFix.Agent.Agent import Agent


def make_browser_toolkit(parent: Agent, create_browser_card_fn) -> Toolkit:
    return Toolkit(
        name="browser",
        ...
        tools=[
            SDK_MCP_Tool(
                ...
                handler=make_create_browser_agent_handler(parent, create_browser_card_fn),
            ),
            SDK_MCP_Tool(
