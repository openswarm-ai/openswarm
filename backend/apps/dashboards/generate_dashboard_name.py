...
SINGLE_AGENT_SYSTEM_PROMPT = "Generate a concise 2-5 word workspace name for a project based on this task. Return only the name with no markdown formatting, nothing else."
MULTI_AGENT_SYSTEM_PROMPT = "Generate a concise 2-5 word workspace name that captures the overall theme of these tasks. Return only the name with no markdown formatting, nothing else."
