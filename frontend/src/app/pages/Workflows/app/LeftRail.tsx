  ...
  return (
    <div style={{ width: 248, flex: 'none', borderRight: `1px solid ${WC.line}`, background: WC.rail, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
      ...
      <div style={{ padding: '4px 8px', flex: 'none', display: 'flex', flexDirection: 'column', gap: 1 }}>
        {/* role="button" keeps pressLandedOnControl true, so hub nav never re-fits the canvas camera (ENG-336) */}
        <div role="button" onClick={nav.goHome} style={homeStyle}>
        ...
        <div role="button" onClick={nav.goCalendar} style={calStyle}>
        ...
        <div role="button" onClick={nav.goNew} style={newStyle}>
      ...
      <div style={{ flex: 'none', borderTop: `1px solid ${WC.line}`, padding: '8px' }}>
        <div role="button" onClick={nav.goTrash} style={trashStyle}>
