...
export function useDashboardInteractions({
  ...
  const handleViewportDoubleClick = useCallback((e: React.MouseEvent) => {
    ...
    // UNfloored on purpose: the 0.5 floor made a spread board unfittable, and centering a too-big
    // box put EVERY card off screen (measured: 0 of 4 visible), which is worse than small cards.
